          ...
          <div class="px-2 sm:px-4 lg:px-6 py-4 w-full max-w-full">
              ...
              <div class="sm:flex sm:justify-between sm:items-center mb-4">
                ...
                <div class="mb-4 sm:mb-0">
                  <h2 class="text-xl md:text-2xl text-gray-800 dark:text-gray-100 font-bold">{{ t('event.sitemap.title') }}</h2>
                </div>
              </div>
              ...
              <div v-for="(tab, index) in tabs" :key="index">
                <div v-if="activeTab === tab.name" class="text-gray-700 dark:text-white text-left pt-3 px-4">
                  ...
                  <div class="flex flex-col space-y-2">
                    ...
                    <EventTab v-if="activeTab === 'AlarmLogDB'" :mode="mode4" :channel="channelComputed" :key="`alarmlogdb-${channelComputed}`"/>
