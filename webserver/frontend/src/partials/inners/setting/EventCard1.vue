      ...
      <div class="space-y-6">
        ...
        <div>
          <div class="flex items-center gap-2 mb-4">
            ...
            <span class="text-xs font-semibold uppercase tracking-wider">Transient Voltage</span>
          </div>
          <div>
        ...
        <div>
          <div class="flex items-center gap-2 mb-4">
            <div class="w-1 h-4 bg-violet-500 rounded-full"></div>
            <span class="text-xs font-semibold uppercase tracking-wider">Transient Current</span>
          </div>
          <div>
            <label class="block text-sm font-medium mb-2">Action</label>
            <div class="flex w-full">
