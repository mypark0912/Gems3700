      ...
      <div class="summary-grid">
        ...
        <div class="summary-item">
          <div class="summary-content">
            <div class="summary-value">{{ realtimeData?.U4.toFixed(1) }} <span class="summary-unit">V</span></div>
        ...
        <div class="summary-item">
          <div class="summary-content">
            <div class="summary-value">{{ realtimeData?.I4.toFixed(2) }} <span class="summary-unit">A</span></div>
        ...
        <div class="summary-item">
          <div class="summary-content">
            <div class="summary-value">{{ realtimeData?.Freq.toFixed(2) }} <span class="summary-unit">Hz</span></div>
            <div class="summary-label"> 주파수 </div>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  setup() {
    ...
    const getVoltageClass = (voltage) => {
      ...
      if (value < 210) return 'voltage-low';
      if (value > 240) return 'voltage-high';
