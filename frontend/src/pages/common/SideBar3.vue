  ...
  setup(props, { emit }) {
    ...
    const isMainActive = computed(() => {
      ...
      if (currentRoute.fullPath.includes("/meter")) {
        if (currentRoute.params.channel === "Main" || propdata === "Main") {
          return true;
        } else {
          return false;
        }
      ...
      } else if (currentRoute.fullPath.includes("/diagnosis")) {
        // ✅ 추가
        if (currentRoute.params.channel === "Main" || propdata === "Main") {
          return true;
        } else {
